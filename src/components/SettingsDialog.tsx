          ...
          <div className="space-y-4">
            <div className="flex gap-4">
              <div className="w-1/2 border-r pr-4">
                <h3 className="text-sm font-medium text-gray-700 mb-2">{t('settings.savedLegends')}</h3>
                    ...
                    >
                      <button
                        onClick={() => {
                          ...
                          setColorMappings(legend.color_mappings);
                        }}
              ...
              <div className="w-1/2">
                <h3 className="text-sm font-medium text-gray-700 mb-2">
                  {selectedLegend ? t('settings.editLegend') : t('settings.newLegend')}
                </h3>
                <div className="space-y-4">
                  <input
                    type="text"
                    ...
                    {Object.entries(CARD_COLORS).map(([color]) => (
                      <div key={color} className="flex items-center gap-2">
                        ...
                        <input
                          ...
                          placeholder={(t('settings.meaningFor')+  t('settings.'+color))}
                  ...
                  >
                    {selectedLegend ? t('settings.updateLegend') : t('settings.saveLegend')}
                  </button>
                </div>
              </div>
            </div>
